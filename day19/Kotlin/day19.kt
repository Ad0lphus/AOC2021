import java.io.*
fun readFileFromResources(fileName:String) = File("../Input/$fileName").readText().lines().filter { it.isNotBlank() }
fun print_day_19() {
    val yellow = "\u001B[33m"
    val reset = "\u001b[0m"
    val green = "\u001B[32m"
    println(yellow + "-".repeat(25) + "Advent of Code - Day 19" + "-".repeat(25) + reset)
    println(green)
    val process = Runtime.getRuntime().exec("figlet Beacon Scanner -c -f small")
...
fun main() {
    print_day_19()
    val input = readFileFromResources("day19.txt")
    val d19 = Day19()
    d19.part1(input)
...
class Day19 {
    fun part1(input: List<String>) {
        ...
        println("Puzzle 1: " + allBeacons.size)
    }

...
print(colored("Advent of Code - Day 21", "yellow").center(80, "-"))
print(colored(figlet_format("Dirac Dice",font="small",justify="center"), 'green'))
print(colored("Output","yellow").center(80, "-"))

f =open('../Input/day21.txt', 'r').read().split('\n')
p1, p2 = int(f[0].strip()[-1]), int(f[1].strip()[-1])
...
print("Puzzle 2: ", max(res2.values()),end='\n\n')

...
print(colored("Advent of Code - Day 10", "yellow").center(80, "-"))
print(colored(figlet_format("Syntax Scoring",font="small",justify="center"), 'green'))
...
print("Puzzle 2: ",scores[len(scores) // 2], "\n")

import java.util.*
import java.io.*
fun readFileFromResources23(fileName:String) = File("../Input/$fileName").readText().lines().filter { it.isNotBlank() }
fun print_day_23() {
    val yellow = "\u001B[33m"
    val reset = "\u001b[0m"
    val green = "\u001B[32m"
    println(yellow + "-".repeat(25) + "Advent of Code - Day 23" + "-".repeat(25) + reset)
    println(green)
    val process = Runtime.getRuntime().exec("figlet Amphipod -c -f small")
...
object Day23 {
    ...
    fun main(args: Array<String>) {
        print_day_23()
        val input: List<String> = readFileFromResources23("day23.txt")
        print("Puzzle 1: ")
        solvePosition(input)

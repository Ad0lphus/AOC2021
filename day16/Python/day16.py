...
Your puzzle answer was ____________________.
'''
from termcolor import colored
from pyfiglet import *
print(colored("Advent of Code - Day 16", "yellow").center(80, "-"))
print(colored(figlet_format("Packet Decoder",font="small",justify="center"), 'green'))

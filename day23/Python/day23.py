...
print(colored("Advent of Code - Day 23", "yellow").center(80, "-"))
print(colored(figlet_format("Amphipod",font="small",justify="center"), 'green'))
...
with open(path.join(path.dirname(__file__), "../Input/day23.txt")) as f:
    ...
    print("Puzzle 2:", solve(rooms),end="\n\n")

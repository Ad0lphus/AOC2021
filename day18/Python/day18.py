...
print(colored("Advent of Code - Day 18", "yellow").center(80, "-"))
print(colored(figlet_format("Snailfish",font="small",justify="center"), 'green'))
...
print('\nPart 1:', magnitude(reduce(sf_add, sf_numbers)))
print('Part 2:', max([magnitude(sf_add(*p)) for p in permutations(sf_numbers, 2)]),end="\n\n")

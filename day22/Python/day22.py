...
print(colored("Advent of Code - Day 22", "yellow").center(80, "-"))
print(colored(figlet_format("Reactor Reboot",font="small",justify="center"), 'green'))
...
def part_2(s):
    ...
    print(f"Puzzle 2: {answer}",end = "\n\n")


input = open("../Input/day22.txt", "r").read()
part_1(input)
part_2(input)
